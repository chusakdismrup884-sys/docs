...
Both classes accept a Bedrock API key via the `bedrock_api_key` parameter or the `AWS_BEARER_TOKEN_BEDROCK` environment variable. They do not require AWS SigV4 credentials.
