...
<Note>
The SDK does not support [decision model evaluators](/langsmith/decision-model-evaluator) yet. These evaluators use a decision model, such as SemIf or Jev, as the judge. To create one, use the UI.
</Note>
